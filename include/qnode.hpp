...
public:
	...
	void set_arm(){ std_srvs::SetBool cmd; srv_client_[0].call(cmd); }; 
	void set_flight_mode(){ std_srvs::SetBool cmd; srv_client_[1].call(cmd); };
	...
	void start_logger(){ std_srvs::SetBool cmd; srv_client_[4].call(cmd); }
	void stop_logger(){ std_srvs::SetBool cmd; srv_client_[5].call(cmd); }
	void send_logger(){ std_srvs::SetBool cmd; srv_client_[6].call(cmd); }
	void move_arm(){ std_srvs::SetBool cmd; srv_client_[7].call(cmd); }
	void move_position(){ std_srvs::SetBool cmd; srv_client_[8].call(cmd); }
	void track_reference()
	{ std_srvs::SetBool cmd; srv_client_[9].call(cmd); srv_client_[10].call(cmd); }
	void use_trajectory(){ std_srvs::SetBool cmd; srv_client_[11].call(cmd); }
